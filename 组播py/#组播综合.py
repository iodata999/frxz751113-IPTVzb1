        ...
        for line in lines:
            ...
            if "," in line:  # 防止文件里面缺失“,”号报错
                ...
                if channel_url == '#genre#':
                    ...
                    # 将频道信息写入m3u文件
                    f.write(f'#EXTINF:-1 tvg-id="{channel_name}" tvg-name="${processedChannelName}" tvg-logo="https://live.fanmingming.com/tv/{channel_name}.png" group-title="{genre}",{channel_name}\n')
