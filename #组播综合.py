...
keywords = ['CCTV1,', 'CCTV11,', 'CCTV12,', 'CCTV13,', 'CCTV14,', 'CCTV15,', 'CCTV16,', 'CCTV17,', 'CCTV2', 'CCTV3', 'CCTV4,', 'CCTV5,', 'CCTV6', 'CCTV7', 'CCTV8', 'CCTV9']  # 需要提取的关键字列表
...
keywords = ['新闻', '综合', '公共', '广东', '安徽', '湖北', '武汉', '湖南']  # 需要提取的关键字列表
pattern = '|'.join(keywords)  # 创建正则表达式模式，匹配任意一个关键字
#pattern = r"^(.*?),(?!#genre#)(.*?)$" #以分类直接复制
